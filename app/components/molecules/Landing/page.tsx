        ...
        <div className="container  ml-[3rem] mt-[2rem] px-6 pt-32 md:pt-40">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <p className='text-lg md:text-xl text-gray-100 max-w-2xl mb-8
              ...
              <span className='text-[#FFA500] font-semibold hover:text-orange-300 
          ...
          <div className="absolute top-10 right-[75%] w-24 h-24 border-t-2 border-r-2 
            border-orange-400/30 animate-[spin_8s_linear_infinite]" />

          <div className="absolute bottom-10 left-[75%] w-32 h-32 border-b-2 border-l-2 
